  ...
  return {
    ...
    objectTypes: {
      ...
      connector: {
        ...
        // No kernel corner handles: a connector's bbox is derived from its
        // curve, so generic handles would float in empty space around it.
        // A selected connector shows its own affordances instead
        // (highlighted path + endpoint dots for re-routing).
        resizable: false,
        // Rotation is meaningless for a curve derived from its boxes
        rotatable: false,
